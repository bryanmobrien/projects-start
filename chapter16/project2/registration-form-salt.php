...
<div class="flex flex-col max-w-md px-4 py-8 bg-white rounded-lg shadow dark:bg-gray-800 sm:px-6 md:px-8 lg:px-10">
    ...
    <div class="p-6 mt-2">
        <form action="process-registration-salt.php" method="post">
            ...
            <div class="flex items-center justify-center mt-2">
                <a href="registration-form-bcrypt.php" class="text-xs text-gray-500 hover:text-gray-700 dark:text-gray-100">
                    Register with bcrypt instead.
                </a>
            </div>
